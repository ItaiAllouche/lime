        ...
        if desc.approach == 'opt':
            if desc.reference_logits is None:
                ...
                reference_desc = KVOptDesc(
                    ...
                    lambda_relevance_multimodal=desc.lambda_relevance_multimodal,
                    lambda_relevance_text=desc.lambda_relevance_text,
                    approach='vanila',
                    modality_bos_idx=desc.modality_bos_idx,
                    modality_eos_idx=desc.modality_eos_idx,
                ...
                reference_logits = self.lm_head(reference_hidden_states[:, slice_indices, :])
                desc.set_reference_logits(reference_logits)
            ...
            kl_loss = nn.functional.kl_div(student_log_probs, reference_probs, reduction="batchmean", log_target=False)
