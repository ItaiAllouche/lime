...
# https://github.com/huggingface/transformers/blob/main/src/transformers/models/qwen2_5_vl/modeling_qwen2_5
#
        ...
        if desc.approach == 'opt':
            if desc.reference_logits is None:
               ...
               # forward of the reference model
                ...
                reference_logits = self.lm_head(reference_hidden_states)
