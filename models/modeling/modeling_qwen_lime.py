...
class QWenLMHeadModel(QWenPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.reference_transformer = None
        ######## itai change ########            
        ...
        if desc.approach == 'opt':
            if desc.reference_logits is None:
               ...
               # forward of the reference model
                ...
                reference_hidden_states = reference_outputs[0]
                reference_lm_logits = self.lm_head(reference_hidden_states)
                desc.set_reference_logits(reference_lm_logits)
            ...
            student_last = lm_logits[torch.arange(lm_logits.size(0), device=lm_logits.device), last_idx, :]
