...
# https://github.com/huggingface/transformers/blob/main/src/transformers/models/qwen2_audio/modeling_qwen2_audio.py 
#
    ...
    def forward(
        ...
        if desc.approach == 'opt':
            if desc.reference_logits is None:
                ...
                desc.set_reference_logits(reference_outputs.logits)
            # optim_args['reference_logits'] = reference_outputs.logits
